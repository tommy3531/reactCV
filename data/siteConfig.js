module.exports = {
  ...
    About 5 years ago I was given a problem and solved it by building a database and have been hooked ever since.  I am always trying to improve my skills by learning and tinkering with new tech.  I am a tenacious <strong>developer</strong> that is not confined to a specific stack or language. <br />
    Currently I am learning react and decided my first project would be a resume site built with <strong>react</strong>.  I decided to use gatsbyjs which is a modern framework that has <strong>react</strong>, <strong>graphql</strong> and many other tools included.  I also like how I can install plugins to help with <strong>SEO</strong>, but most importantly I can focus on writting code.<br />
    I have experience with <strong>Javascript</strong>, <strong>NodeJS</strong>, <strong>React</strong>, <strong>Java</strong>, <strong>Swift</strong>, <strong>Mobile Development</strong>.`,
  skills: [
    {
      name: 'Java',
      level: 50,
